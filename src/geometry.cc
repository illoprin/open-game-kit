...
Geometry Geometry::CreatePlane(glm::vec2 size) {
  std::vector<ModelVertex> v {
    { { -size.x/2, 0, -size.y/2 }, { 0, 1, 0 }, { 0, size.y } },
    { { size.x/2, 0, -size.y/2 }, { 0, 1, 0 }, { size.x, size.y } },
    { { size.x/2, 0, size.y/2 }, { 0, 1, 0 }, { size.x, 0 } },
    { { -size.x/2, 0, size.y/2 }, { 0, 1, 0 }, { 0, 0 } }
  };
